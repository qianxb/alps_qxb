...
void GC0310MIPI_Sensor_Init(void)
{
  ...
  /////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0x83,0x12);//0b
...
*/
	...
	GC0310MIPI_write_cmos_sensor(0xd1,0x2f);//34 
	GC0310MIPI_write_cmos_sensor(0xd2,0x2f);//34 
	GC0310MIPI_write_cmos_sensor(0xd3,0x42);//40
	GC0310MIPI_write_cmos_sensor(0xd5,0xfe);
...
/*	GC0310MIPI_write_cmos_sensor(0xd0,0x38);//skin red
	...
	GC0310MIPI_write_cmos_sensor(0xd0,0x36);//skin white//38
	GC0310MIPI_write_cmos_sensor(0xd1,0xfd);
	GC0310MIPI_write_cmos_sensor(0xd2,0x08);//06
