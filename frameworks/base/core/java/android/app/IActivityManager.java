...
public interface IActivityManager extends IInterface {
    ...
    /// M: [process suppression] @{
    int SUPPRESS_PACKAGES_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 508;
    int UNSUPPRESS_PACKAGES_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 509;
    int READY_TO_GET_CONTENT_PROVIDER_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 510;
    /// M: [process suppression] @}
