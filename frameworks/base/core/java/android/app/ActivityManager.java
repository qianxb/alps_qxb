...
public class ActivityManager {
    ...
    /**
     * @param packageList The list of the package names.
     * @param suppressPolicy The suppression policy.
     * @param tag The tag of the client.
     *
     * @hide This is not available to third party applications
     * because it allows them to break other applications
     * by stopping their services, removing their alarms, etc.
     */
    public void suppressPackages(List<String> packageList, int suppressPolicy, String tag) {
        try {
            ActivityManagerNative.getDefault().suppressPackages(packageList, suppressPolicy,
                    tag);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    /**
     * @see #suppressPackages()
     * @hide
     */
    public void unsuppressPackages(String tag) {
        try {
            ActivityManagerNative.getDefault().unsuppressPackages(tag);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
