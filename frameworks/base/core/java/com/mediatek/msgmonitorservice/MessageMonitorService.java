...
public class MessageMonitorService extends IMessageLogger.Stub {
    ...
    protected static HashMap<MessageMonitorLogger.MSGLoggerInfo, IMessageLoggerWrapper>
        sMSGLoggerMap = new HashMap<MessageMonitorLogger.MSGLoggerInfo, IMessageLoggerWrapper>();
    ...
    private final class MSGLoggerDeathRecipient implements IBinder.DeathRecipient {
        ...
        public void binderDied() {
            ...
            try {
                while (iter.hasNext())
                {
                    MessageMonitorLogger.MSGLoggerInfo key =
                        (MessageMonitorLogger.MSGLoggerInfo) iter.next();
                    if (currentMSGLoggerName.equals(key.msgLoggerName))
                    {
                        Log.d(TAG, "MSGLoggerDeathRecipient - UnregisterMsgLogger:" +
                            currentMSGLoggerName);
    ...
    public void registerMsgLogger(String msgLoggerName, int pid, int tid,
        IMessageLoggerWrapper callback) {
        Log.d(TAG, "RegisterMsgLogger " + msgLoggerName);
        MessageMonitorLogger.MSGLoggerInfo msgLoggerInfo =
            new MessageMonitorLogger.MSGLoggerInfo();
