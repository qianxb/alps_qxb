...
public class ContextInfo {
    ...
    public static class Type {
        ...
        /**
         * A constant describing the audio noise level context.
         *
         * @hide
         */
        public static final int NOISE_LEVEL = 1008;

        /**
         * A constant describing the freefall context.
         */
        public static final int FREE_FALL = 1009;

        /**
         * A constant describing the tap context.
         *
         * @hide
         */
        public static final int TAP = 1010;

        /**
         * A constant describing the twist context.
         *
         * @hide
         */
        public static final int TWIST = 1011;

        /**
         * A constant describing the snapshot context.
         */
        public static final int SNAPSHOT = 1012;

        /**
         * A constant describing the pedestrian-dead-reckoning context.
         *
         * @hide
         */
        public static final int PDR = 1013;
    }
    ...
    public static class UserActivity {
        ...
        public static class State {
            ...
            /**
             * A constant describing the device is walking.
             */
            public static final int WALKING = 59;

            /**
             * A constant describing the device is running.
             */
            public static final int RUNNING = 60;

            /**
             * A constant describing the device is climbing.
             */
            public static final int CLIMBING = 61;
        }
    ...
    /**
     * Data noise level for noise detection.
     *
     * @hide
     */
    public static class NoiseLevel {
        private NoiseLevel() {
         ...
         /**
           * The data slot index for noise level value.
           * <p/>
           * Value range: [1, 5] <br/>
           * Data type: Integer
           */
        ...
        /**
          * The data slot index for the the time in millisecond at which the noise was detected.
          * <p/>
          * Data type: long<br/>
          * Unit: Millisecond
          */
    ...
    public static class FreeFall {
        ...
        /**
          * The data slot index for free fall value.
          * <p/>
          * Value range: 1 indicates the device is free falling; 0 indicates not.<br/>
          * Data type: Integer
          */
        public static final int VALUE = 56;

        /**
          * The data slot index for the the time in millisecond at which the free fall was detected.
          * <p/>
          * Data type: long<br/>
          * Unit: Millisecond
          *
    ...
    /**
     * Data indices for device tap context.
     *
     * @hide
     */
    public static class Tap {
        ...
        /**
         * The data slot index for device tap state.
         * <p/>
         * Value range: 1 indicates the device is tapped; 0 indicates not.<br/>
         * Data type: Integer
         */
        public static final int VALUE = 64;

        /**
         * The data slot index for the time in nanosecond at which the tap was detected.
         * <p/>
         * Data type: long<br/>
         * Unit: Second
         *
    ...
    /**
     * Data indices for device twist context.
     *
     * @hide
     */
    public static class Twist {
        ...
        /**
         * The data slot index for device twist state.
         * <p/>
         * Value range: 1 indicates the device is twisted; 0 indicates not.<br/>
         * Data type: Integer
         */
        public static final int VALUE = 67;

        /**
         * The data slot index for the time in nanosecond at which the twist was detected.
         * <p/>
         * Data type: long<br/>
         * Unit: Second
         *
    ...
    /**
     * Data indices for device snapshot context.
     */
    public static class Snapshot {
        ...
        /**
         * The data slot index for device snapshot state.
         * <p/>
         * Value range: 1 indicates the device is snapshoted; 0 indicates not.<br/>
         * Data type: Integer
         */
        public static final int VALUE = 70;

        /**
         * The data slot index for the time in nanosecond at which the snapshot was detected.
         * <p/>
         * Data type: long<br/>
         * Unit: Second
         *
         * @hide
         */
        public static final int TIMESTAMP = 71;
    }


    /**
     * Data indices for device pedestrian-dead-reckoning context.
     *
     * @hide
     */
    public static class PDR {
        ...
        public static class Value {
            ...
            /**
             * The data slot index of x axis for the currect user displacement relative to
             * previous location.
             * <p/>
             * Value range: [0, 300]<br/>
             * Data type: Integer
             * Unit: Centimeter
             */
            public static final int X = 73;
            /**
             * The data slot index of y axis for the currect user displacement relative to
             * previous location.
             * <p/>
             * Value range: [0, 300]<br/>
             * Data type: Integer
            ...
            /**
             * The data slot index of z axis for the currect user displacement relative to
             * previous location.
             * <p/>
             * Value range: [0, 0],only support two dimension.<br/>//TBD
             * Data type: Integer
             * Unit: Centimeter
             */
        ...
        /**
         * The data slot index for the time in nanosecond at which the pedestrian-dead-reckoning
         * was detected.
         * <p/>
         * Data type: long<br/>
         * Unit: Second
    ...
    public static int getDataType(int index) {
        if (index < Clock.TIME || index > PDR.TIMESTAMP) {
        ...
        switch(index) {
            ...
            case NoiseLevel.TIMESTAMP:
            case FreeFall.TIMESTAMP:
            case Tap.TIMESTAMP:
            case Twist.TIMESTAMP:
