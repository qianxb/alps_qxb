...
public interface IPerfServiceWrapper {
    ...
    public static final int SCN_SW_BOOST_1      = 13;
    public static final int SCN_SW_BOOST_2      = 14;
    public static final int SCN_SW_BOOST_3      = 15;
    public static final int SCN_MAX             = 16; /* should be (last scenario + 1) */
