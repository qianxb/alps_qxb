...
interface INfcAdapterGsmaExtras {
    ...
    /**
     * Set the GSMA Off Host App Info
     */
    boolean setGSMAOffHostAppInfo(in GSMAOffHostAppInfo appInfo);

    /**
     * Get the GSMA Off Host App Infos
     */
    List<GSMAOffHostAppInfo> getGSMAOffHostAppInfos();

    /**
     * Return the list of Secure Elements which can be used by the NFC Controller 
     */
    int[] getAvailableSeList(int batLevel);
