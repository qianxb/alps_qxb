...
public class HdmiDef {
    ...
    public static final int SINK_4KP30 = (1 << 23);
    public static final int SINK_4KP24 = (1 << 24);
    ...
    public static int[] sResolutionMask = new int[] { SINK_480P, SINK_576P,
            ...
            SINK_1080P60, SINK_1080P50, 0, 0, 0, 0, 0, 0, SINK_4KP30, SINK_4KP24};

    public static int[] getAllResolutions() {
        int[] resolutions = new int[] { RESOLUTION_3840X2160P_30HZ,
                RESOLUTION_3840X2160P_24HZ, RESOLUTION_1920X1080P_60HZ,
    ...
    public static int[] getPreferedResolutions(int index) {
        ...
        if (0 == index) {
            ...
            prefered = new int[] { AUTO + RESOLUTION_3840X2160P_30HZ,
