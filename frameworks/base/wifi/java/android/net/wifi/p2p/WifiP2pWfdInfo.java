...
public class WifiP2pWfdInfo implements Parcelable {
    ...
    public String toString() {
        ...
        sbuf.append("\n WFD info. loan to Crossmount? ").append(mCrossmountLoaned);
    ...
    public WifiP2pWfdInfo(WifiP2pWfdInfo source) {
        if (source != null) {
            ...
            mCrossmountLoaned = source.mCrossmountLoaned;
        }
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(mCrossmountLoaned ? 1 : 0);
    }
    ...
    public void readFromParcel(Parcel in) {
        ...
        mExtCapa = in.readInt();
        mCrossmountLoaned = (in.readInt() == 1);
    }
