    ...
    private String bringUpServiceLocked(ServiceRecord r, int intentFlags, boolean execInFg,
        ...
        if (app == null && !permissionsReviewRequired) {
            ...
            if ("1".equals(SystemProperties.get("persist.runningbooster.support")) ||
                ...
                eventHookData.set(r.appInfo.packageName, r.appInfo.uid, r.delayedServiceCallerPkg,
                        r.delayedServiceCallerUid, clientList, clientUidList,
                        "service", suppressAction);
