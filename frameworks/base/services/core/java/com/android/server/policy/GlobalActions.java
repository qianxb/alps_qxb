        ...
        for (int i = 0; i < defaultActions.length; i++) {
            ...
            if (GLOBAL_ACTION_KEY_POWER.equals(actionKey)) {
                mItems.add(new PowerAction());
 				mItems.add(new RebootAction());//+weifm 2016-12-6
                mItems.add(mAirplaneModeOn);//+weifm 2017-2-20
                mItems.add(mSilentModeAction);//+weifm 2017-2-20
...
//++weifm 2016-12-6
	private final class RebootAction extends SinglePressAction implements LongPressAction {
		private RebootAction() {
            super(com.android.internal.R.drawable.ic_lock_power_reboot_tablet_alpha,
                R.string.global_action_power_reboot_tablet);
        }
		@Override
        public boolean onLongPress() {
            UserManager um = (UserManager) mContext.getSystemService(Context.USER_SERVICE);
        ...
        @Override
        public void onPress() {
            mWindowManagerFuncs.reboot(false);//+weifm: boolean confirm = false:reboot immediately, don't show dialog to confirm
        }
	}
//--weifm
