...
static jboolean hdmi_ioctl(int code, long value) __attribute__((unused));
...
static jboolean enableHDMI(JNIEnv *env, jobject clazz, jboolean enable) __attribute__((unused));
...
static jboolean IPOPowerONHDMI(JNIEnv *env, jobject clazz, jboolean enable) __attribute__((unused));
...
static jboolean hdmiPowerEnable(JNIEnv *env, jobject clazz, jboolean enable) __attribute__((unused));
...
static jboolean hdmiPortraitEnable(JNIEnv *env, jobject clazz, jboolean enable) __attribute__((unused));
...
static jboolean enableVideo(JNIEnv *env, jobject clazz, jboolean enable) __attribute__((unused));
...
static jboolean enableCEC(JNIEnv *env, jobject clazz, jboolean enable) __attribute__((unused));
...
static jboolean enableHDCP(JNIEnv *env, jobject clazz, jboolean enable) __attribute__((unused));
...
static jboolean enableAudio(JNIEnv *env, jobject clazz, jboolean enable) __attribute__((unused));
...
static jboolean GetDeviceStatus(JNIEnv* env, jobject clazz, jboolean is_audio_enabled, jboolean is_video_enabled ) __attribute__((unused));
...
static jintArray getEDID(JNIEnv* env, jobject clazz) __attribute__((unused));
...
static jcharArray getCECAddr(JNIEnv* env, jobject clazz) __attribute__((unused));
...
static jintArray getCECCmd(JNIEnv* env, jobject clazz) __attribute__((unused));
...
static jboolean setVideoConfig(JNIEnv* env, jobject clazz, jint vformat) __attribute__((unused));
...
static jboolean setAudioConfig(JNIEnv* env, jobject clazz, jint aformat) __attribute__((unused));
...
static jboolean setDeepColor(JNIEnv* env, jobject clazz, jint colorSpace, jint deepColor) __attribute__((unused));
...
static jboolean setHDCPKey(JNIEnv* env, jobject clazz, jbyteArray key) __attribute__((unused));
...
static jboolean setHDMIDRMKey(JNIEnv* env, jobject clazz) __attribute__((unused));
...
static jboolean NeedSwDrm(JNIEnv *env, jobject clazz) __attribute__((unused));
...
static jboolean setCECAddr(JNIEnv* env, jobject clazz, jbyte laNum, jbyteArray la, jchar pa, jchar svc) __attribute__((unused));
...
static jboolean setCECCmd(JNIEnv* env, jobject clazz, jbyte initAddr, jbyte destAddr, jchar opCode, jbyteArray operand, jint size, jbyte enqueueOk) __attribute__((unused));
...
static jboolean isHdmiForceAwake(JNIEnv *env, jobject clazz) __attribute__((unused));
...
static jboolean notifyOtgState(JNIEnv* env, jobject clazz, jint aformat) __attribute__((unused));
...
static jint getDisplayType(JNIEnv* env, jobject clazz) __attribute__((unused));
...
static jint getCapabilities(JNIEnv* env, jobject clazz) __attribute__((unused));
